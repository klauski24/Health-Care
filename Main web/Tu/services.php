...
<body>
                ...
                <div class="the-dich-vu">
                    ...
                    <div class="noi-dung-the">
                        ...
                        <div style="display: flex; justify-content: center; gap: 20px;">
                            ...
                            <a href="khamdichvu.php?service_id=<?php echo $row['id']; ?>" 
                                class="datlich" 
    ...
    timKiem.addEventListener('keyup', function() {
        const tuKhoaKhongDau = loaiBoDau(this.value.toLowerCase()); 
        
        const danhSachDichVu = document.querySelectorAll('.the-dich-vu');

        danhSachDichVu.forEach(function(the) {
            const tenDichVu = the.querySelector('.ten-dv').innerText.toLowerCase();
            const tenDichVuKhongDau = loaiBoDau(tenDichVu);

            if (tenDichVuKhongDau.includes(tuKhoaKhongDau)) {
                the.style.display = ""; 
            } else {
